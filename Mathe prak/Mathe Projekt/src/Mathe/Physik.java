...
public class Physik {
    ...
    public static void Ball_Collision(Ball k1, Ball k2, double eR, double eB){
        ...
        double bn[]={ball1[0]-ball2[0],ball1[1]-ball2[1]};// ball2 -> ball1
        double bl=Math.sqrt(Math.pow(bn[0],2)+Math.pow(bn[1],2));
        double b[]={(1/bl)*bn[0],(1/bl)*bn[1]};
    ...
    public String Wert(Ball k1, Ball k2){
        String w="v1: "+k1.vX;
    return w;
    }
}
